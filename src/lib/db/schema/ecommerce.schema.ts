import { pgTable, text, timestamp, integer, numeric, boolean, index, uniqueIndex } from "drizzle-orm/pg-core";
...
export const order = pgTable("order", {
  ...
  shippingAddressId: text("shipping_address_id").notNull().references(() => address.id),
  createdAt: timestamp("created_at").notNull().defaultNow(),
  updatedAt: timestamp("updated_at").notNull().defaultNow(),
}, (table) => [
